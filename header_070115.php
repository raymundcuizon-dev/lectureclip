...
function redir() {
    if (!$_COOKIE['lc_login_id']) {
        echo "<script>window.location.replace('restricted.php');</script>";
    }
}
                ...
                <div class="inner">
                    ...
                    <ul id="hbtns" class="clearfix">
                        ...
                        if(!isset($_SESSION['fb_login'])){
                            ...
                            // $fb_lastName = $_SESSION['fb_lastname'];
                            // $fb_givenName = $_SESSION['fb_firstname'];                   

                            // $checkUser = $obj->singleData($fb_email, "email", "tbl_ut_pass");                                                       
                            // if($checkUser == NULL){
                            //     //echo "NOT EXISTS!";
                            //     $obj->newReg($fb_givenName, $fb_lastName, "tbl_ut_user");
                            ...
                            //         //echo "name1: " . $name1;
                            //     } 
                            //     $fb_data = array('uid' => $uid, 'email' => $_SESSION['fb_email'] );                                

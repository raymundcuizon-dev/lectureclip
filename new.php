...
?>
    ...
    <div id="contents" class="clearfix column1">
        <div class="inner">
                ...
                //GET CATEGORIES
                $where = 'WHERE tbl_lc_course.publish_flg = 1 GROUP BY tbl_m_category.catid ORDER BY MAX(tbl_lc_lecture.regdate) DESC LIMIT ' .$limit. ' OFFSET ' .$page;
                ...
                <?php  
                    ...
                    $where = 'WHERE tbl_lc_course.publish_flg = 1 AND tbl_m_category.catid =' .$catid. ' GROUP BY tbl_lc_course.cid ORDER BY MAX(tbl_lc_lecture.regdate) DESC';
                    $table = 'tbl_lc_course 
                    ...
                    $data = array('tbl_lc_course.cid',
                            ...
                            'tbl_ut_user.name1',
                            'MIN(tbl_lc_lecture.price) as l_price');  
